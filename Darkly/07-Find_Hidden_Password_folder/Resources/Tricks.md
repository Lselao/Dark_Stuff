...
1.Go to http://192.168.101.204/ home page
2.In the address bar, type ' /?page=../etc/passwd.'  A pop up alert will say you're getting close to the exploit.
3.Continue adding '../' and move a step back in the directories until the alert message gives you the flag.
